  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-900 via-purple-800 to-blue-900 flex flex-col items-center py-10 px-4">
      ...
      <div className="text-center text-white mb-12">
        <h1 className="text-3xl sm:text-6xl font-extrabold leading-tight mb-2 tracking-wide">LIC Godda</h1>
        <h2 className="text-lg sm:text-2xl font-light mb-4 italic">powered by Laxman sir</h2>
